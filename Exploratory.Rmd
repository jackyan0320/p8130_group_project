...
raw_cp = raw_data[,c(1,2,3,5,6,7,8,9,10,12,11,13,14,15,16,17,18,4)]

raw_cp(x = raw_data[,1:17], y = state_cp[,18], nbest=2, method="Cp")

leaps(x = raw_cp[,1:17], y = raw_cp[,18], nbest=2, method="adjr2")
